package com.example.rahulhariharan.gestureview.gestures.views;
...
import com.example.rahulhariharan.gestureview.gestures.GestureController;
import com.example.rahulhariharan.gestureview.gestures.GestureControllerForPager;
import com.example.rahulhariharan.gestureview.gestures.State;
import com.example.rahulhariharan.gestureview.gestures.animation.ViewPositionAnimator;
import com.example.rahulhariharan.gestureview.gestures.internal.DebugOverlay;
...
import com.example.rahulhariharan.gestureview.gestures.views.interfaces.GestureView;
...
public class GestureFrameLayout extends FrameLayout implements GestureView, AnimatorView {
    ...
    *//** Task used to crop bitmap async from UI thread *//*
    private WeakReference<BitmapCroppingWorkerTask2> mBitmapCroppingWorkerTask;
    // endregion
    ...
    *//**
    ...
    public void setCropShape(CropImageView.CropShape cropShape) {
        mCropOverlayView.setCropShape(CropOverlayView.CropShape.RECTANGLE);
    }
  ...
  *//*public Guidelines getGuidelines() {
    ...
    *//**
    ...
    public void setGuidelines(CropImageView.Guidelines guidelines) {
        mCropOverlayView.setGuidelines(CropOverlayView.Guidelines.ON);
    }
    ...
    *//**
    ...
    public void getCroppedImageAsync() {
        getCroppedImageAsync(0, 0, GestureFrameLayout.RequestSizeOptions.NONE);
    }
    ...
    *//**
    ...
    public void getCroppedImageAsync(int reqWidth, int reqHeight) {
        getCroppedImageAsync(reqWidth, reqHeight, GestureFrameLayout.RequestSizeOptions.RESIZE_INSIDE);
    }
    ...
    *//**
     ...
     * @param options the resize method to use, see its documentation
     *//*
    public void getCroppedImageAsync(int reqWidth, int reqHeight, GestureFrameLayout.RequestSizeOptions options) {
    ...
    *//**
    ...
    public void saveCroppedImageAsync(Uri saveUri) {
        saveCroppedImageAsync(saveUri, Bitmap.CompressFormat.JPEG, 90, 0, 0, GestureFrameLayout.RequestSizeOptions.NONE);
    }
    ...
    *//**
    ...
    public void saveCroppedImageAsync(
        ...
        saveCroppedImageAsync(
                saveUri, saveCompressFormat, saveCompressQuality, 0, 0, GestureFrameLayout.RequestSizeOptions.NONE);
    }
    ...
    *//**
    ...
    public void saveCroppedImageAsync(
        ...
        saveCroppedImageAsync(
                ...
                reqWidth,
                reqHeight,
                GestureFrameLayout.RequestSizeOptions.RESIZE_INSIDE);
    }
    ...
    *//**
    ...
    public void saveCroppedImageAsync(
            ...
            int reqWidth,
            int reqHeight,
            GestureFrameLayout.RequestSizeOptions options) {
        if (mOnCropImageCompleteListener == null) {
            throw new IllegalArgumentException("mOnCropImageCompleteListener is not set");
        }
        startCropWorkerTask(
    ...
    *//**
    ...
    public void setImageUriAsync(Uri uri) {
        if (uri != null) {
            ...
            mCropOverlayView.setInitialCropWindowRect(null);
            mBitmapLoadingWorkerTask = new WeakReference<>(new BitmapLoadingWorkerTask2(this, uri));
    ...
    *//**
    ...
    public void startCropWorkerTask(
        ...
        if (bitmap != null) {
            ...
            BitmapCroppingWorkerTask2 currentTask =
            ...
            reqWidth = options != GestureFrameLayout.RequestSizeOptions.NONE ? reqWidth : 0;
            reqHeight = options != GestureFrameLayout.RequestSizeOptions.NONE ? reqHeight : 0;

            int orgWidth = bitmap.getWidth() * mLoadedSampleSize;
            int orgHeight = bitmap.getHeight() * mLoadedSampleSize;
            if (mLoadedImageUri != null
                    && (mLoadedSampleSize > 1 || options == GestureFrameLayout.RequestSizeOptions.SAMPLING)) {
                mBitmapCroppingWorkerTask =
                        new WeakReference<>(
                                new BitmapCroppingWorkerTask2(
                                        this,
                                        mLoadedImageUri,
                                        getCropPoints(),
                                        mDegreesRotated,
